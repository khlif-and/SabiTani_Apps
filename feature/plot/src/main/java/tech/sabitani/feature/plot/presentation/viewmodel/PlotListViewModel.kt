...
@HiltViewModel
internal class PlotListViewModel
    @Inject
    constructor(
        ...
        ContainerHost<PlotListState, PlotListEffect> {
        private val route = savedStateHandle.toRoute<PlotListRoute>()

        override val container =
            container<PlotListState, PlotListEffect>(
        ...
        private fun reduceState(block: (PlotListState) -> PlotListState) =
            intent {
                reduce { block(state) }
            }
